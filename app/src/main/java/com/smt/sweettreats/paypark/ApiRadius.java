                ...
                ref2.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot dsp : dataSnapshot.getChildren()) {
                            ...
                            if(dsp.child("sensor").exists()){featured = true;}
                            ...
                            for(DataSnapshot a: dsp.child("availability").getChildren()){
                                ...
                                if(date.equals(input_booking_date.getText().toString())
                                    ...
                                    rentalSlots.add(new slot(String.valueOf(dsp.getKey()), outcode, "London", availability, price, "driveway", 1, featured));
